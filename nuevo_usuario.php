<?php
    ...
    if (!isset($_SESSION['usuario_usuario'])) {
        ...
        $guardar_usuario = $conn->prepare("INSERT INTO users (name, email, password, user_type, token_desbloqueo, iv_desbloqueo, created_at, updated_at) VALUES (:usuario_usuario, :email_contacto, :usuario_password, :usuario_tipo, :token_desbloqueo, :iv_desbloqueo, :created_at, :updated_at);");
        ...
        $guardar_usuario->bindParam(":created_at", $created_at);
        $guardar_usuario->bindParam(":updated_at", $updated_at);
