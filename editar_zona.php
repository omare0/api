<?php
    ...
    if (!isset($_SESSION['usuario_usuario'])) {
        ...
        $zona_info = $conn->prepare("SELECT * FROM zonas WHERE id = :id;");
        $zona_info->bindParam(":id", $_GET['id_zona']);
        $zona_info->execute();

        $zona = $zona_info->fetchObject();
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Editar Zona</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-4 col-lg-offset-4">
                    ...
                    <?php 
                        ...
                        $log_data = 'Agregó zona: ' . $nombre_zona;
                        ...
                        <div class="panel-body">
                                <form action="" method="POST" autocomplete="off" role="form">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="nombre_zona" value="<?php echo $zona->zona ?>" required />
                                    </div>
                                    <button type="submit" class="btn btn-success btn-block" name="editar">Editar Zona</button>
                                </form>              
                        </div>
                        <!-- /.panel-body -->
                    </div>
